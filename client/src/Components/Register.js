  ...
  const addUser = async(e) => {
    ...
    if(fname === ""){
      ...
      if(res.status === 201){
        ...
        setinputVal({
          ...inputVal,fname:"",email:"",password:"",cpassword:""
        })
      }
      ...
      <div className="form_data">
        ...
        <form>
          <div className="form_input">
            ...
            <input type="text" onChange={setValue} name="fname" value={inputVal.fname} id="fname" placeholder='Enter your Name'/>
          </div>
          <div className="form_input">
          ...
          <div className="form_input">
            ...
            <div className="two">
                <input type={!cpassShow ? "password" : "text"} onChange={setValue} name="cpassword" value={inputVal.cpassword} id="cpassword" placeholder='Confirm Password'/>
